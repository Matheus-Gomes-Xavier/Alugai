...
// Buscar itens da categoria 'marcenaria'
...
<head>
  ...
  <title>Marcenaria - AlugaAi</title>
...
<body>
  ...
  <header class="bg-dark text-white py-3">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav>
        ...
        <a href="marcenaria.php" class="text-warning mx-2">Marcenaria</a>
  ...
  <section class="py-5 bg-light">
    <div class="container">
      <h2 class="mb-4 text-center">Itens para Marcenaria</h2>
      <div class="row g-4">
